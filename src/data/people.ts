// ─────────────────────────────────────────────────────────────────────
// The people of the network: the coordinating team and the members.
// Shared by /people (full cards) and the home page (portrait wall, counts).
// ─────────────────────────────────────────────────────────────────────

/** Same slug rule as PersonCard, so a name can deep-link to its card on /people. */
export const slugOf = (name: string) =>
  name.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "");

export const lastName = (n: string) =>
  n.replace(/\s*\(.*?\)\s*/g, " ").trim().split(" ").pop()!;
export const sortByName = (a: { name: string }, b: { name: string }) =>
  lastName(a.name).localeCompare(lastName(b.name));

// Coordinating Team members
export const coordinatingCommittee = [
  {
    name: "Maria Robinson",
    role: "Behavioural Science Group",
    institution: "University of Warwick",
    email: "maria.robinson@warwick.ac.uk",
    image: "/images/people/robinson-maria.png",
  ...
  },
  {
    ...
    image: "/images/people/yu-kenny.jpg",
...
export const networkMembers = [
  {
    ...
    role: "Quantitative Psychology and Individual Differences",
    institution: "KU Leuven",
    email: "sigert.ariens@kuleuven.be",
    image: "/images/people/ariens-sigert.png",
  ...
  },
  {
    ...
    image: "/images/people/heathcote-andrew.png",
    website: "https://www.ampl-psych.com/team/andrew-heathcote/",
    website2: "https://www.uva.nl/en/profile/h/e/a.j.heathcote/a.j.heathcote.html",
  ...
  },
  {
    ...
    image: "/images/people/tuerlinckx-francis.jpg",
  ...
  },
  {
    ...
    image: "/images/people/hutmacher-fabian.jpg",
    website: "https://www.mcm.uni-wuerzburg.de/en/kp/team/pd-dr-fabian-hutmacher/",
    bio: "Fabian Hutmacher is a Senior Scientist at the University of Würzburg, Germany. His research aims to advance our understanding of the psychology of the digital age. He investigates how people remember their lives, construct their identities, navigate digital environments, and evaluate the vast amount of information — and misinformation — they encounter online. His work integrates theories and methods from social, cognitive, and media psychology. He also has a keen interest in meta-science and in thinking about how psychological theories and concepts can be improved.",
  },
  {
    name: "Craig Hedge",
    role: "School of Psychology",
    institution: "Aston University",
    email: "c.hedge@aston.ac.uk",
    image: "/images/people/hedge-craig.jpg",
    bio: "Craig Hedge is a cognitive psychologist interested in attention control and decision-making. He is particularly interested in whether cognitive modelling improves our ability to predict and explain individual differences in real-world behaviours, relative to traditional behavioural measures.",
  },
  {
    name: "Greg Cox",
    ...
    image: "/images/people/cox-greg.jpg",
    website: "https://sites.google.com/view/lincd/home",
    bio: "Greg Cox is a cognitive scientist who studies how perception, memory, learning, and decision making unfold together over time to give rise to knowledge and action. In his lab he pairs detailed behavioural measures—response times, speed–accuracy trade-offs, motor trajectories, and eye movements—with mathematical and computational models of how retrieval and decision processes evolve moment to moment. Much of his work reconstructs memory in the psychological space recovered from behaviour, treating retrieval as the overlap between a current percept and the coverage that experience has laid down, so that perceptual similarity and association carry a measured rather than a freely fitted interpretation. He is broadly interested in the links between episodic and semantic memory and in the principled, invariance-respecting formulation and comparison of cognitive models.",
  },
  {
    name: "David Kellen",
    role: "Department of Psychology",
    institution: "Syracuse University",
    email: "dkellen@syr.edu",
    image: "/images/people/kellen-david.jpg",
  ...
  },
  {
    ...
    email: "m.i.eronen@rug.nl",
    image: "/images/people/eronen-markus.jpg",
  ...
  },
  {
    ...
    image: "/images/people/vanpaemel-wolf.jpg",
    website: "https://ppw.kuleuven.be/okp/people/wolf_vanpaemel/",
  ...
  },
  {
    ...
    image: "/images/people/sanborn-adam.jpg",
    website: "https://sampling.warwick.ac.uk",
    website2: "https://profiles.warwick.ac.uk/pssjak-adam-sanborn",
  ...
  {
    name: "Marina Dubova",
    role: "Cognitive Epistemology Lab",
    institution: "UC Berkeley",
    email: "mdubova@santafe.edu",
    image: "/images/people/dubova-marina.jpg",
    website: "https://www.mdubova.com/",
    bio: "Marina Dubova is an assistant professor at UC Berkeley, where she directs the Cognitive Epistemology Lab. She studies the cognitive mechanisms of scientific discovery, using computational modeling and empirical work with scientists to understand how we actually observe and build theories about the world, and how we ought to.",
  },
  {
    name: "Andrew Perfors (Andy)",
    role: "Complex Human Data Hub",
    institution: "University of Melbourne",
    email: "andrew.perfors@unimelb.edu.au",
    image: "/images/people/perfors-andrew.jpg",
    website: "https://findanexpert.unimelb.edu.au/profile/800124-andrew-perfors",
    bio: "Andrew Perfors is the Director of the Complex Human Data Hub in the School of Psychological Sciences at the University of Melbourne. He uses computational models of the mind, in combination with behavioural experiments, to study human cognition: how we acquire and use concepts and language, how we make decisions, how we learn from and share information with each other, and how that process of collaborative meaning-making changes the information environment itself. Andy has many thoughts about the role of models and computation in cognitive science, not just in terms of epistemology (what do they tell us, and how can they best be used?) but also given the real-world incentives and power structures that science is embedded in.",
  },
  {
    name: "Marie-Ann Sengewald",
    role: "Department of Psychology",
    institution: "FAU Erlangen-Nürnberg",
    email: "marie.sengewald@fau.de",
    image: "/images/people/sengewald-marie-ann.jpg",
    website: "https://www.methodenlehre.phil.fau.de/en/",
    website2: "https://www.m-sengewald.de/",
  ...
  },
  {
    ...
    role: "Department of Psychology",
    institution: "Syracuse University",
    email: "yhe231@syr.edu",
    image: "/images/people/he-yiou.jpg",
    website: "https://yiouhe.com/",
    bio: "Yiou He is a cognitive psychology PhD student at Syracuse University, working with Dr. David Kellen. Her current research uses formal modeling to study memory and confidence judgments. She is broadly interested in various methodological issues surrounding model evaluation and behavioral inference.",
  },
  {
    name: "Yufei Wu",
    role: "Quantitative Psychology and Individual Differences",
    institution: "KU Leuven",
    email: "yufei.wu@kuleuven.be",
    image: "/images/people/wu-yufei.jpg",
    website: "https://ppw.kuleuven.be/okp/team/Yufei_Wu/",
    bio: "Yufei Wu is a PhD student in the Research Group of Quantitative Psychology and Individual Differences at KU Leuven. Her research focuses on applying amortized Bayesian inference methods to cognitive modeling and the modeling of reaction time data. As simulation-based inference makes Bayesian inference feasible for an increasingly broad class of models, she is interested not only in developing efficient inference methods, but also in understanding the assumptions and interpretation of the models to which these methods are applied.",
  },
  {
    name: "Tyler Brunet",
    role: "Egenis, the Centre for the Study of the Life Sciences",
    institution: "University of Exeter",
    email: "T.D.P.Brunet@exeter.ac.uk",
    image: "/images/people/brunet-tyler.jpg",
    website: "https://experts.exeter.ac.uk/37087-tyler-brunet",
    bio: "Tyler Brunet is a philosopher of science working in the philosophy of biology (molecular biology) and the philosophy of technology (AI and robotics). In both areas he brings strange and interesting empirical examples to bear on traditional philosophical problems: what synthetic macromolecules imply about the possibility of subjective experience in machines, what achlorophyllous orchid symbioses tell us about the nature of selection, and what generative AI tells us about the nature of explanation. He also does technical work in evolutionary theory, on evolutionary neutrality and on evolutionary reticulation in molecular and microbiological evolution. In logic he focuses on modal logics, applications of logic within metaphysics, and the use of category theory within modal semantics, having given a categorial perspective on modal (counterfactual) accounts of causation and on modal realism. Much of this work is motivated by taking a “local” approach to problems that are typically examined globally — a local account of causation, or of ontological primitives — alongside purely technical work on metalogical relationships between coalgebraic logics.",
  },
  {
    name: "Brandon Turner",
    role: "Model-based Cognitive Neuroscience Lab",
    institution: "The Ohio State University",
    email: "turner.826@osu.edu",
    image: "/images/people/turner-brandon.jpg",
    website: "https://turner-mbcn.com",
    bio: "Brandon Turner is a professor in the Psychology Department at The Ohio State University, where he leads the Model-based Cognitive Neuroscience Lab. His research interests include dynamic models of cognition and perceptual decision making, efficient methods for performing likelihood-free and likelihood-informed Bayesian inference, and unifying behavioral and neural explanations of cognition. His current focus is on understanding how selective attention causes “cognitive inertia”, a pattern of information search that is dictated by previous allocations of attention, and how curated information (e.g., Google, YouTube) can harm or distort learning.",
  },
  {
    ...
    image: "/images/people/davis-stober-clintin.jpg",
  ...
  },
  {
    ...
    image: "/images/people/matzke-dora.jpg",
    website: "https://www.ampl-psych.com/team/dora-matzke/",
    website2: "https://www.uva.nl/en/profile/m/a/d.matzke/d.matzke.html",
  ...
  },
  {
    ...
    email: "h.singmann@ucl.ac.uk",
    image: "/images/people/singmann-henrik.jpg",
  ...
  },
  {
    ...
    email: "lqhuang@cuhk.edu.hk",
    image: "/images/people/huang-liqiang.jpg",
    website: "https://www.pbs-trinity.org/ce",
    bio: "Liqiang Huang is a professor at the Chinese University of Hong Kong. His research relies on large-scale experiments—typically requiring 20,000–40,000 hours of data collection—to investigate cognitive mechanisms in depth. His approach begins with stimulus-driven, rather than theory-driven, experimental design, and proceeds through data-guided yet theory-oriented, iterative, and exploratory model building.",
  },
  {
    ...
    role: "Behavioural Science Group",
    institution: "University of Warwick",
    image: "/images/people/zhao-wenjia.jpg",
  ...
  },
  {
    ...
    image: "/images/people/chirimuuta-mazviita.jpg",
    photoCredit: "Julie Broadfoot",
    photoCreditUrl: "https://www.juliebee.co.uk",
    website: "https://outsidecolour.net",
    links: [
      { label: "Synthese (2020)", url: "https://doi.org/10.1007/s11229-020-02713-0" },
      { label: "Lakatos lecture", url: "https://outsidecolour.net/wp-content/uploads/2025/12/chirimuuta-2025-lakatos-lecture.pdf" },
    ],
  ...
  },
  {
    ...
    image: "/images/people/vandekerckhove-joachim.jpg",
  ...
  },
  {
    ...
    image: "/images/people/benjamin-aaron.jpg",
  ...
  },
  {
    ...
    image: "/images/people/zhang-weiwei.jpg",
  ...
  },
  {
    ...
    image: "/images/people/rebholz-tobias.jpg",
  ...
  },
  {
    ...
    image: "/images/people/kvam-peter.jpg",
