...
panelists:
  ...
  - name: "Joachim Vandekerckhove"
    ...
    role: "Cognition and Individual Differences Lab"
    photo: "/images/people/JV.jpg"
    bio: "Joachim Vandekerckhove is a professor in the Department of Cognitive Sciences at the University of California, Irvine, where he directs the Cognition and Individual Differences Lab. His work sits at the intersection of mathematical models of cognition and Bayesian statistics, with a focus on response time modeling, model fitting, and computational methods that make cognitive models estimable in practice. He is known for joint modeling approaches that link the parameters of process models to psychometric structure, so that individual differences are expressed in terms of cognitive mechanisms rather than summary scores. He also works on metascientific questions about how psychological science accumulates evidence, including publication bias, the evaluation of statistical evidence, and open research practices."
