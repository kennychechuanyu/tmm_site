...
type: "webinar"
featured: true
description: "A TMM panel on what it means for a psychological model to be interpretable—and whether the idea still holds in an era of machine-learned cognition. Date, speakers, and panel members to be confirmed."
---

> **Programme in progress.** The date, invited speakers, and panel members are still being
> confirmed. If you'd like to be notified when the details are finalised,
> [join the network](/community) or get in touch with the coordinating team.
